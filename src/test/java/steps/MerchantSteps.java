...
public class MerchantSteps {
  ...
  public void user_click_on_New_Merchant_button() throws Throwable {
	  ...
	  Assert.assertEquals("User is navigated to Merchnats Registraion Page", merchantRegistrationPage.newMerchantRegistrationLabel.getText(),AcquirerPortalGlobal.MERCHNAT_REGISTRATION_TITLE);
  }
