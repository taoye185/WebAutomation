...
import utils.SetUp;
import pageobjects.ConfirmationMessageBoxPage;
import pageobjects.ConfirmationMessageBoxPage;
import pageobjects.GmailPage;
import pageobjects.portalusers.PortalUserPage;
...
public class PortalUserSteps {
	...
	public void user_delete_the_portal_user_record() {
		try {
			...
			Thread.sleep(1000);
			ConfirmationMessageBoxPage.setConfirmationBoxElements();
			Thread.sleep(1000);
			ConfirmationMessageBoxPage.confirmationMessageOK.click();
		} catch (InterruptedException ex) {
			System.out.println("ERROR : ==================== /n" + ex.getMessage() + "/n====================");
